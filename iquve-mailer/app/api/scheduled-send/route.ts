...
export async function GET(req: NextRequest) {
  ...
  for (const campaign of scheduled) {
    try {
      ...
      results.push({ campaign: campaign.title, sent: sentCount, failed: failCount, remaining: finalPending.length })
    } catch (err) {
